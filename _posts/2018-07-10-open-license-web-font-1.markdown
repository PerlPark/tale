...
img: open-license-web-font_1.png # Add image post (optional)
...
우리가 폰트를 다운로드하면 흔히 받게 되는 ttf, otf 파일을 웹폰트 파일인 eot, woff 등으로 변환만 해주면 웹사이트에서 사용할 수 있습니다. <span class="smalltext_gray">(※요즘엔 HTML과 CSS가 발전하여 그냥 ttf 파일을 사용해도 됩니다. 하지만 웹폰트보다는 무거워서 변환을 권장합니다.)</span> 방법이 쉬운 만큼, 맘에 드는 폰트 아무거나 내려받아 사용하면 된다고 쉽게 말할 수 있다면 참 좋겠지만... 대부분의 폰트가 라이선스 상, 웹폰트로 사용이 금지됩니다. (또는 별도의 계약 필요) 그러니 웬만하면 모든 용도로 허가된 오픈 라이선스 폰트를 사용하는 게 좋겠죠?  
  
### 구글 폰트 (Google Fonts)
![Google Fonts]({{site.baseurl}}/assets/post_img/open-license-web-font-1_1.png) ![Google Fonts]({{site.baseurl}}/assets/post_img/open-license-web-font-1_2.png)  
  
많이들 알고 계신 구글 폰트입니다.  
여러 언어의 웹폰트를 제공 중이고, 대부분의 오픈 라이선스 한글 폰트가 여기에서 제공되고 있습니다.  
<span class="smalltext_red">(※ 한글 본고딕(Noto sans KR)은 이 페이지에서 제공되지 않습니다! 아래 스포카 한 산스 소개 영역을 참고해주세요.)</span>  
...
![Google Fonts]({{site.baseurl}}/assets/post_img/open-license-web-font-1_3.png) ![Google Fonts]({{site.baseurl}}/assets/post_img/open-license-web-font-1_4.png)  
...
<span class="smalltext_gray">출처) Ludens님</span>  
  
<https://github.com/gshn/fonts>  
<span class="smalltext_gray">출처) sir 커뮤니티 gshn님</span>  
...
<span class="smalltext_gray">출처) Korea Web Design 남반장님</span>  
...
<span class="smalltext_gray">출처) WIT – NTS UIT BLOG 김원준님</span>